...
from rede import redeNeural as R
import random

class EstrategiaEvolutiva:

    def __init__(self, tamanhoPopulacao: int, quantidadeGenes: int, redeNeural: R.RedeNeural, problemaMinimizacao: bool = True) -> None:
        """
    ...
    #def _cruzarIndividuos(self, pai1: Individuo, pai2: Individuo) -> (Individuo, Individuo):
        # """
